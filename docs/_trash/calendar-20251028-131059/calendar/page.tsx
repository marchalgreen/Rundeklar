...
export default function CalendarOverviewPage() {
  return (
    <article className="space-y-12">
      <DocPageHeader
        eyebrow="Calendar"
        title="Calendar module overview"
        description="The Clairity calendar keeps every optician, optometrist, and service bay in sync so you never double-book a room or miss an appointment."
      />
