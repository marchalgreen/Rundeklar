...
const Header = () => {
  ...
  return (
    <header className="relative flex items-center justify-between ring-1 ring-[hsl(var(--line)/.12)] bg-[hsl(var(--surface)/.7)] px-6 py-4 backdrop-blur shadow-[inset_0_-1px_0_hsl(var(--line)/.08)]">
      ...
      <nav aria-label="Primær navigation" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
        <div className="grid grid-cols-3 gap-3 pointer-events-auto" style={{ width: '500px' }}>
